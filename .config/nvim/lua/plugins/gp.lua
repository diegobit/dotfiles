...
```
    ...
    local conf = {
      ...
      agents = {
        ...
        {
          provider = 'googleai',
          name = 'Gemini Code Flash latest',
          chat = false,
          command = true,
          model = { model = 'gemini-flash-latest', temperature = 0.0, top_p = 1 },
          system_prompt = system_prompt_code, --require('gp.defaults').code_system_prompt,
        },
        {
          provider = 'googleai',
          name = 'Gemini Code Pro 2.5',
          chat = false,
          command = true,
